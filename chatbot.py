...
helps = [ "Sure Buddy! I'm here to help. You can ask me about the weather, request a fun fact, a joke, how many messages we chatted so far (ask me for the count!), or just say hello!" ] 
...
while True: 
    ...
    if user_input == "":
        ...
        print("Bot:", random.choice(helps), name)
